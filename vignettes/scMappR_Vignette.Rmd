...
Here, we will walk through the output of the above example sorting by name and working downwards.
  ...
  * bulk_pathway_enrichment: png and Rdata file of traditional g:ProfilR analysis of GO:BP, REAC, and KEGG databases.
   * bulk_TF_enrichment: png and Rdata file of traditional g:ProfilR analysis of TF database.
   

  * scMappR_vignette_celltype_specific_cellWeighted_Foldchanges_upregulated_heatmap.pdf: Row-normalized cellWeighted_Foldchanges of upregulated genes that are also cell-type specific (in the signature matrix).
  * scMappR_vignette_celltype_specific_cellWeighted_Foldchanges_downregulated_heatmap.pdf: Row-normalized cellWeighted_Foldchanges of downregulated genes that are also cell-type specific (in the signature matrix).
  * scMappR_vignette__cellWeighted_Foldchanges_upregulated_DEGs_heatmap.pdf: row-normalized cellWeighted_Foldchanges of upregulated genes.
  * scMappR_vignette__cellWeighted_Foldchanges_downregulated_DEGs_heatmap.pdf: row-normalized cellWeighted_Foldchanges of downregulated genes.
  ...
  * scMappR_vignette_reordered_pathways: .Rdata file containing list of outputs from g"profileR or gprofiler2 that are  "GOBP", "reac", and "kegg" enrichments after re-ordering.
 ...
 * scMappR_vignette_bulk_pathways.Rdata: g:profileR enrichment of bulk GOBP, REAC, and KEGG.
